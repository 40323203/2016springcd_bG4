...
bg4_40123128 = Blueprint('bg4_40123128', __name__, url_prefix='/bg4_40123128', template_folder='templates')
...
'''
    return outstring
@bg4_40123128.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@bg4_40123128.route('/circle36/<x>/<degree>', defaults={'y': 0})
@bg4_40123128.route('/circle36/<x>/<y>/<degree>')
...
@bg4_40123128.route('/circle2/<x>/<y>')
@bg4_40123128.route('/circle2', defaults={'x':0, 'y':0})
def circle2(x, y):
...
@bg4_40123128.route('/chain/<x>/<y>')
@bg4_40123128.route('/chain', defaults={'x':0, 'y':0})
def chain(x,y):
...
'''
    ...
    return outstring
@bg4_40123128.route('/fourgear', defaults={'n1':32,'n2':21,'n3':15,'n4':10})
@bg4_40123128.route('/fourgear/<n1>/<n2>/<n3>/<n4>')
...
class chain():
    ...
    # 利用鏈條起點與旋轉角度定義繪圖, 使用內定的 color, border 與 linewidth 變數
    def basic_rot(self, x1, y1, rot, color="blue", border=True, linewidth=4, scale=1):
        self.x1 = x1
        self.y1 = y1
        self.rot = rot
        self.color = color
...
#雪花辦
x1, y1 = mychain.basic_rot(0, 0, 0)
x2, y2 = mychain.basic_rot(x1, y1, 60)
x3, y3 = mychain.basic_rot(x1, y1, -60)
x4, y4 = mychain.basic_rot(x1, y1, 0)
x5, y5 = mychain.basic_rot(x2, y2, 30)
x6, y6 = mychain.basic_rot(x5, y5, 90)
x7, y7 = mychain.basic_rot(x5, y5, 30)
x8, y8 = mychain.basic_rot(x5, y5, -30)
x9, y9 = mychain.basic_rot(x7, y7, 90)
x10, y10 = mychain.basic_rot(x7, y7, 30)
x11, y11 = mychain.basic_rot(x7, y7, -30)

 
x1, y1 = mychain.basic_rot(0, 0, 0+60)
x2, y2 = mychain.basic_rot(x1, y1, 60+60)
x3, y3 = mychain.basic_rot(x1, y1, -60+60)
x4, y4 = mychain.basic_rot(x1, y1, 0+60)
x5, y5 = mychain.basic_rot(x2, y2, 30+60)
x6, y6 = mychain.basic_rot(x5, y5, 90+60)
x7, y7 = mychain.basic_rot(x5, y5, 30+60)
x8, y8 = mychain.basic_rot(x5, y5, -30+60)
x9, y9 = mychain.basic_rot(x7, y7, 90+60)
x10, y10 = mychain.basic_rot(x7, y7, 30+60)
x11, y11 = mychain.basic_rot(x7, y7, -30+60)


x1, y1 = mychain.basic_rot(0, 0, 0+120)
x2, y2 = mychain.basic_rot(x1, y1, 60+120)
x3, y3 = mychain.basic_rot(x1, y1, -60+120)
x4, y4 = mychain.basic_rot(x1, y1, 0+120)
x5, y5 = mychain.basic_rot(x2, y2, 30+120)
x6, y6 = mychain.basic_rot(x5, y5, 90+120)
x7, y7 = mychain.basic_rot(x5, y5, 30+120)
x8, y8 = mychain.basic_rot(x5, y5, -30+120)
x9, y9 = mychain.basic_rot(x7, y7, 90+120)
x10, y10 = mychain.basic_rot(x7, y7, 30+120)
x11, y11 = mychain.basic_rot(x7, y7, -30+120)


x1, y1 = mychain.basic_rot(0, 0, 0+180)
x2, y2 = mychain.basic_rot(x1, y1, 60+180)
x3, y3 = mychain.basic_rot(x1, y1, -60+180)
x4, y4 = mychain.basic_rot(x1, y1, 0+180)
x5, y5 = mychain.basic_rot(x2, y2, 30+180)
x6, y6 = mychain.basic_rot(x5, y5, 90+180)
x7, y7 = mychain.basic_rot(x5, y5, 30+180)
x8, y8 = mychain.basic_rot(x5, y5, -30+180)
x9, y9 = mychain.basic_rot(x7, y7, 90+180)
x10, y10 = mychain.basic_rot(x7, y7, 30+180)
x11, y11 = mychain.basic_rot(x7, y7, -30+180)


x1, y1 = mychain.basic_rot(0, 0, 0+240)
x2, y2 = mychain.basic_rot(x1, y1, 60+240)
x3, y3 = mychain.basic_rot(x1, y1, -60+240)
x4, y4 = mychain.basic_rot(x1, y1, 0+240)
x5, y5 = mychain.basic_rot(x2, y2, 30+240)
x6, y6 = mychain.basic_rot(x5, y5, 90+240)
x7, y7 = mychain.basic_rot(x5, y5, 30+240)
x8, y8 = mychain.basic_rot(x5, y5, -30+240)
x9, y9 = mychain.basic_rot(x7, y7, 90+240)
x10, y10 = mychain.basic_rot(x7, y7, 30+240)
x11, y11 = mychain.basic_rot(x7, y7, -30+240)


x1, y1 = mychain.basic_rot(0, 0, 0+300)
x2, y2 = mychain.basic_rot(x1, y1, 60+300)
x3, y3 = mychain.basic_rot(x1, y1, -60+300)
x4, y4 = mychain.basic_rot(x1, y1, 0+300)
x5, y5 = mychain.basic_rot(x2, y2, 30+300)
x6, y6 = mychain.basic_rot(x5, y5, 90+300)
x7, y7 = mychain.basic_rot(x5, y5, 30+300)
x8, y8 = mychain.basic_rot(x5, y5, -30+300)
x9, y9 = mychain.basic_rot(x7, y7, 90+300)
x10, y10 = mychain.basic_rot(x7, y7, 30+300)
x11, y11 = mychain.basic_rot(x7, y7, -30+300)
