...
'''
    return outstring
@bg4_40323203.route('/circle36/<degree>', defaults={'x': 0, 'y': 0})
@bg4_40323203.route('/circle36/<x>/<degree>', defaults={'y': 0})
@bg4_40323203.route('/circle36/<x>/<y>/<degree>')
...
@bg4_40323203.route('/circle2/<x>/<y>')
@bg4_40323203.route('/circle2', defaults={'x':0, 'y':0})
def circle2(x, y):
...
@bg4_40323203.route('/chain/<x>/<y>')
@bg4_40323203.route('/chain', defaults={'x':0, 'y':0})
def chain(x,y):
...
'''
    ...
    return outstring
@bg4_40323203.route('/fourgear', defaults={'n1':32,'n2':21,'n3':15,'n4':10})
@bg4_40323203.route('/fourgear/<n1>/<n2>/<n3>/<n4>')
